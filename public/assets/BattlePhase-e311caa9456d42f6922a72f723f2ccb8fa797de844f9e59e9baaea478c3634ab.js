function startBattlePhase(game_package, phase){
	...
	function preload() {
		...
		//load player image
		game.load.image("player_1", "/player_1.png");
		game.load.image("player_2", "/player_2.png");
		game.load.image("player_3", "/player_3.png");
		game.load.image("player_4", "/player_4.png");
		
		//load projectile image
		game.load.image("projectile_1", "/projectile.png");
		game.load.image("projectile_2", "/projectile.png");
		game.load.image("projectile_3", "/projectile.png");
